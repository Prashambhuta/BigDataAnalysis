...
if __name__ == "__main__":
    ...
    final_df = pd.DataFrame.from_dict(final_result, orient='index', columns = [
        "Number"])
    final_df = final_df.sort_values(by=["Number"], ascending=False)
    final_df.to_csv("../assignment-1/output.csv")
